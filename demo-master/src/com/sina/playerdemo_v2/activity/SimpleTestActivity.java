...
import com.sina.sinavideo.sdk.widgets.playlist.VDVideoPlayListGridItemTextView;
...
public class SimpleTestActivity extends Activity implements
	...
	VDVideoPlayGridView gridView;
	VDVideoListInfo infoList;
	VDVideoPlayListGridItemTextView textView;
...
//		textView = (VDVideoPlayListGridItemTextView)findViewById(R.id.)
		// 从layout里面得到播放器ID
...
//		
//		info = new VDVideoInfo();
//		info.mTitle = "这就是一个测试视频4";
//		info.mPlayUrl = "http://v.iask.com/v_play_ipad.php?vid=131386882&tags=videoapp_android";
//		infoList.addVideoInfo(info);
//		
//		info = new VDVideoInfo();
//		info.mTitle = "这就是一个测试视频5";
//		info.mPlayUrl = "http://v.iask.com/v_play_ipad.php?vid=131386882&tags=videoapp_android";
//		infoList.addVideoInfo(info);
//		
//		
//		info = new VDVideoInfo();
//		info.mTitle = "这就是一个测试视频6";
//		info.mPlayUrl = "http://v.iask.com/v_play_ipad.php?vid=131386882&tags=videoapp_android";
//		infoList.addVideoInfo(info);
//		
//		info = new VDVideoInfo();
//		info.mTitle = "这就是一个测试视频7";
//		info.mPlayUrl = "http://v.iask.com/v_play_ipad.php?vid=131386882&tags=videoapp_android";
//		infoList.addVideoInfo(info);
		
		for (int i = 0; i < 35; i++) {
			info = new VDVideoInfo();
			info.mTitle = "这就是一个测试视频"+i;
			info.mVideoPosition = i;
			info.mPlayUrl = "http://v.iask.com/v_play_ipad.php?vid=131386882&tags=videoapp_android";
			infoList.addVideoInfo(info);
		}
		...
		mVDVideoView.setPlayerChangeListener(new OnVDVideoPlayerChangeListener() {
			
			@Override
			public void OnVDVideoPlayerChangeSwitch(int index, long position) {
				// TODO Auto-generated method stub
				Toast.makeText(SimpleTestActivity.this, "oooooo", Toast.LENGTH_LONG).show();
...
//		}
		gridView = (VDVideoPlayGridView) findViewById(R.id.play_glist_view);
		if (gridView != null) {
			gridView.onVideoList(infoList);
			gridView.setCurrent(5);
		}
		// 初始化播放器以及播放列表
	...
	public void onPlaylistClick(VDVideoInfo info, int p) {
		...
		Toast.makeText(SimpleTestActivity.this, "p:"+p, Toast.LENGTH_LONG).show();
		mVDVideoView.play(p);
	}
